...
if __name__ == '__main__':
    # 🔧 Set paths to Odoo 17 and Odoo 18 modules (e.g., 'sale', 'purchase', 'account')
    path_odoo17 = '/path/to/odoo17/addons/sale'
    path_odoo18 = '/path/to/odoo18/addons/sale'
    output_dir = './model_diff_output'

    print("🔍 Collecting model fields from Odoo 17...")
    models_v17 = collect_models(path_odoo17)

    print("🔍 Collecting model fields from Odoo 18...")
    models_v18 = collect_models(path_odoo18)

    print("📊 Comparing fields...")
    diffs = compare_model_fields(models_v17, models_v18)

    print("📝 Exporting report...")
    md_file, csv_file = export_diff_to_markdown_csv(diffs, models_v17, models_v18, output_dir)
